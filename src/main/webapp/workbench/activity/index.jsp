...
<head>
    ...
    <script type="text/javascript">
        ...
        function fun2() {
            ...
            console.log($("#addActivityForm").serialize() + "&createTime=" + SystemTime);
            $.ajax({
    ...
    <div style="width: 100%; position: absolute;top: 5px; left: 10px;">
        ...
        <div class="btn-toolbar" role="toolbar"
            ...
            <div class="btn-group" style="position: relative; top: 18%;">
                <button type="button" id="create-Activity" class="btn btn-primary" data-toggle="modal">
                    <span class="glyphicon glyphicon-plus"></span>创建
                </button>
                <button type="button" class="btn btn-default" data-toggle="modal"><span
