    ...
    <script type="text/javascript">
        $(function () {
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                $.each(data.aList, function (i, item) {
                                    html += '<tr>';
                                    html += '<td><input type="radio" name="activityCh" value="' + item.id + '"></td>';
            ...
            $("#activityBtn").click(function () {
                ...
                $("#activity").val($radio.parent().next().html());
    ...
    <div class="modal-dialog" role="document" style="width: 90%;">
        <div class="modal-content">
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;" id="activitySearch"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="activityBtn">保存</button>
            </div>
        </div>
    </div>
</div>
...
<div id="create-transaction2"
    ...
    <form action="workbench/clue/convert.do" method="post" id="tranForm">
        ...
        <input type="hidden" name="appellation" value="${param.appellation}">
...
<div id="operation" style="position: relative; left: 40px; height: 35px; top: 100px;">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input class="btn btn-default" type="button" onclick="self.location=document.referrer;" value="取消">
</div>
</body>
</html>