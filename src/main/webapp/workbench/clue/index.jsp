    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#createBtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#create-clueOwner").val("40f6cdea0bd34aceb77492a1656d9fb3");
            ...
            $("#editBtn").click(function () {
                var length = $("input[name=clueId]:checked").length;
                if (length > 1) {
                    alert("亿分抱歉，只能选择一条记录进行修改操作");
                    return false;
                } else if (length === 0) {
                    alert("亿分抱歉，必须选择一条记录进行修改");
                    return false;
                }
                $.ajax({
                    ...
                    success: function (data) {
                        /*
                        * data:
                        * success true/false,List<User> uList, Clue c
                        */
                        if (data.success) {
                            var ul = "";
                            $.each(data.uList,function (i,item) {
                                ul += "<option value='" + item.id + "'>" + item.name + "</option>";
                            });
                            $("#edit-clueOwner").html(html);
                            $("#edit-clueOwner").val("40f6cdea0bd34aceb77492a1656d9fb3");
                            $("#edit-fullname").val(data.c.name);
                            $("#edit-company").val("");
                            $("#edit-surname").val("");
                            $("#edit-email").val("");
                            $("#edit-job").val("");
                            ...
                            $("#edit-contactSummary").val("");
                            $("#edit-nextContactTime").val("");
                            $("#edit-address").val("");
                        } else {
                            alert("修改查询失败");
                        }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.dataList, function (i, item) {
                        ...
                        html += '<td><input type="checkbox" name="clueId"/></td>';
                        html += '<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href=\'workbench/clue/detail.do?id='+ item.id+'\';">' + item.fullname + item.appellation + '</a></td>';
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <select class="form-control" id="edit-call">
                                ...
                                <c:forEach items="${appellationList}" var="al">
                                    <option value="${al.value}">${al.text}</option>
                                </c:forEach>
                            </select>
                        </div>
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" id="search-state">
                            ...
                            <c:forEach items="${clueStateList}" var="csL">
                                <option value="${csL.value}">${csL.text}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
